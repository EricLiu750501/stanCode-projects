...
def add_data_for_name(name_data, year, rank, name):
    """
    this code can add the data you input, can transform it  format to format :param name_data
    :param name_data: dict, has name, year, year's rank in it
                      format : {name{year, rank}, name{year, rank}, ......}
                      e.g. : {'Kylie': {'2010': '57', '2000': '104'}, 'Nick': {'2010': '37'}
                             , 'Kate': {'2010': '208', '2000': '108'}, 'Sammy': {'1990': '90'}}
    :param year: str, the year
    :param rank: str, name's rank in 'year'
